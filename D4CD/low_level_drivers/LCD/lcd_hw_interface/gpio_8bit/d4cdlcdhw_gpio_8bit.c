...
* @date      Feb-14-2011
* 
* @brief     D4CD driver - gpio_8bit hardware lcd driver source c file 
*
******************************************************************************/
...
#define d4cdlcdhw_gpio_8bit_ID 1


// copilation enable preprocessor condition
// the string d4cdtch_gpio_8bit_ID must be replaced by define created one line up
  ...
  ******************************************************************************/
  static unsigned char D4CDLCDHW_Init_Gpio_8bit(void);
  static unsigned char D4CDLCDHW_DeInit_Gpio_8bit(void);
  static unsigned char D4CDLCDHW_SendData_Gpio_8bit(unsigned char value);
  static unsigned char D4CDLCDHW_SendCmd_Gpio_8bit(unsigned char cmd);
  static unsigned char D4CDLCDHW_SendNibbleCmd_Gpio_8bit(unsigned char cmd);
  static unsigned char D4CDLCDHW_ReadData_Gpio_8bit(void);
  static unsigned char D4CDLCDHW_ReadCmd_Gpio_8bit(void);
  static unsigned char D4CDLCDHW_PinCtl_Gpio_8bit(D4CDLCDHW_PINS pinId, D4CDHW_PIN_STATE setState);
  ...
  ******************************************************************/
  ...
  const D4CDLCDHW_FUNCTIONS d4cdlcdhw_gpio_8bit = 
  {
    D4CDLCDHW_Init_Gpio_8bit,    
    D4CDLCDHW_SendData_Gpio_8bit,
    D4CDLCDHW_SendCmd_Gpio_8bit,
    D4CDLCDHW_SendNibbleCmd_Gpio_8bit,
    D4CDLCDHW_ReadData_Gpio_8bit,
    D4CDLCDHW_ReadCmd_Gpio_8bit,
    D4CDLCDHW_PinCtl_Gpio_8bit,
    D4CDLCDHW_DeInit_Gpio_8bit
  };
  /**************************************************************//*!
  *
  * Local variables
  ...
  ******************************************************************/
  ...
  //-----------------------------------------------------------------------------
  // FUNCTION:    D4CDLCDHW_Init_Gpio_8bit
  ...
  //-----------------------------------------------------------------------------
  // FUNCTION:    D4CDLCDHW_DeInit_Gpio_8bit
  // SCOPE:       Low Level Driver API function
  ...
  //-----------------------------------------------------------------------------
  // FUNCTION:    D4CDLCDHW_SendData_Gpio_8bit
  // SCOPE:       Low Level Driver API function
  ...
  //                      0 - Failed
  //-----------------------------------------------------------------------------
  static unsigned char D4CDLCDHW_SendData_Gpio_8bit(unsigned char data)
  {       
  ...
  //-----------------------------------------------------------------------------
  // FUNCTION:    D4CDLCDHW_SendCmd_Gpio_8bit
  // SCOPE:       Low Level Driver API function
  ...
  {       
    ...
    (void)D4CDLCDHW_SendData_Gpio_8bit(cmd);
  ...
  //-----------------------------------------------------------------------------
  // FUNCTION:    D4CDLCDHW_ReadData_Gpio_8bit
  // SCOPE:       Low Level Driver API function
  ...
  //-----------------------------------------------------------------------------
  // FUNCTION:    D4CDLCDHW_ReadCmd_Gpio_8bit
  // SCOPE:       Low Level Driver API function
  ...
  //-----------------------------------------------------------------------------
  // FUNCTION:    D4CDLCDHW_PinCtl_Gpio_8bit
  // SCOPE:       Low Level Driver API function
...
#endif //(D4CD_MK_STR(D4CD_LLD_LCD_HW) == d4cdlcdhw_gpio_8bit_ID)